...
export class Migration1740759006921 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "split_sheet_entries" DROP CONSTRAINT "FK_38c0308e21c6f2037372ec4b41e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "split_sheet_entries" DROP CONSTRAINT "FK_b416c09d151e75d358488f5489e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "split_sheets" DROP CONSTRAINT "FK_6fd198aec672ad50d8b4d1d6eab"`,
    );
