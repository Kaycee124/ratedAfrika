...
export class LabelsService {
  ...
  // I'll continue with more methods in the next part to keep this readable.
  // Would you like me to show you the rest of the service implementation,
  // including findOne, update, remove, and other specialized methods?
